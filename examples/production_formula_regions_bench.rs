...
use triblespace::core::query::residual::{
    ActionGeometry, ActionOutcome, ActionSite, FormulaScope, ProgramScope, ResidualLowering,
    ResidualShadowEpoch, ResidualShadowStatus, ResidualStateIter, ResidualStateStats,
};
...
impl Mode {
    ...
    fn lowering(self) -> ResidualLowering {
        match self {
            Self::B => ResidualLowering::new(FormulaScope::OpaqueLeaves, ProgramScope::Production),
            Self::C => {
