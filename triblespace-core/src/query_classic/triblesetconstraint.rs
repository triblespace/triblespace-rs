...
impl TribleSetConstraint {
    ...
    ///
    /// Constant positions behave as positions that are already bound, but do
    /// not enter the constraint's variable set.
...
impl<'a> Constraint<'a> for TribleSetConstraint {
    /// Returns exactly the variable terms in the pattern.
