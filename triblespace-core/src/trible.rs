...
/// One scratch row used while deriving an intrinsic entity.
///
...
/// the leading 16 bytes in place. Its exact 64-byte representation also lets
/// the canonical row sequence be hashed as one contiguous byte slice.
///
