...
/// at packed-word boundaries, into disjoint kill-only regions. With a 2048
/// crossover the recursive leaves are about 1024 candidates wide, so the
/// largest common-plan CPU regions divide without touching GPU routing, which
/// is decided before this leaf.
#[cfg(feature = "parallel")]
const PARALLEL_CONFIRM_MIN: usize = 2048;
