...
/// Distributed sync via iroh: [`net::peer::Peer<S>`] wraps a local store with
/// DHT-announced, capability-authenticated blob transfer and durable lazy
/// fetch wants. Gated behind the `net` feature.
#[cfg(feature = "net")]
